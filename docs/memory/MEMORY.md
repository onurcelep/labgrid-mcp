...
- [Green CI ≠ fresh installs](lockfile-blind-ci-open-bounds.md) — CI proves the locked graph only; open upper bounds resolve live on install (mcp 2.0 broke 0.1.0). Bound every direct dep; smoke-test the published artifact cold.
